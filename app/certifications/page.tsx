...
/**
 * ORDERING RULE:
 * 1) Top vendor credentials (badges preferred over certificate-page duplicates)
 * 2) Strong professional / university courses
 * 3) Internal & compliance / awareness
 */

/* 1) TOP CREDENTIALS (VENDOR) */
const CERTS_TOP: Cert[] = [
  // New badges added
  { title: 'Oracle Siebel CRM Foundations Associate (Badge)', src: '/images/OSCRMCFA.jpg' },
  { title: 'OCI 2025 — AI Foundations Associate (Badge)', src: '/images/OCI25AICFA.jpeg' },
  ...
  { title: 'Oracle ML using Autonomous Database — Associate (Badge)', src: '/images/OMLADB2024CA.jpg' },
  { title: 'Java SE: Programming II — Oracle', src: '/images/JavaCert_page1.png' },

  // Kept 1 representation only (removed duplicate “certificate page” versions for these)
  ...
  // Older but still relevant Oracle creds (badges kept; page dupes removed)
...
const CERTS_PRO: Cert[] = [
  ...
  { title: 'GIU — AI Feature Roadmaps', src: '/images/GIU AI Feature Roadmaps Course Certificate_page1.png' },
    ...
    <div>
      ...
      <main className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <p className="mt-2 max-w-2xl text-sm text-zinc-400">
          Ordered by vendor credentials first, then professional/university courses, then internal & general.
        </p>
        ...
        <p className="mt-8 text-xs text-zinc-500">Will be updating soon</p>
      </main>
      <Footer />
    </div>
  );
